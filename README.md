...
- uses: actions/setup-python@5fda3b95a4ea91299a34e894583c3862153e4b97
  with:
    python-version: "3.13"
- uses: kohli217/codex-workspace-bootstrap@v0.8.0
  with:
    path: .
    strict: "true"
...
- Repository instruction/configuration and project-marker inputs are not trusted through symbolic links.
...
```powershell
py -m pip install "https://github.com/kohli217/codex-workspace-bootstrap/releases/download/v0.8.0/codex_workspace_bootstrap-0.8.0-py3-none-any.whl"
```
